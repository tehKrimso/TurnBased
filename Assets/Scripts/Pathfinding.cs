...
public class Pathfinding : MonoBehaviour
{
	...
	public void Setup(int width, int height, float cellSize)
	{
		...
		gridSystem = new GridSystem<PathNode>(width,height, cellSize, 0, LevelGrid.FLOOR_HEIGHT, (GridSystem<PathNode> g, GridPosition gridPosition) => new PathNode(gridPosition));
